  ...
  return (
    <AnimatePresence>
      <div className=" absolute z-[90] w-screen ">
        ...
        >
          <motion.div
            className="relative z-1 drop-shadow-xl xl:ml-6 lg:ml-6  mt-5 xl:mt-0 lg:mt-0 overflow-hidden"
          ...
          >
            <motion.img
              ...
              src={images.ty2}
              className="xl:w-[500px] lg:w-[500px] object-cover
               xl:h-[400px] lg:h-[400px] h-[300px] w-[260px]"
            />
          </motion.div>
          <motion.div
          ...
          >
            ...
            />
            <p
              className=" absolute xl:top-[250px] lg:top-[250px]
            top-[125px] text-[14px]
            xl:ml-4 lg:ml-4
             text-white font-bold xl:text-xl lg:text-xl z-[4000] xl:px-2 lg:px-2 "
            >
        ...
        <div
          className="flex flex-col xl:flex-row lg:flex-row bg-white justify-center
        ...
        >
          ...
          >
            ...
            />
            <p
              className=" absolute xl:bottom-[10px] lg:bottom-[10px] bottom-2 xl:ml-2 lg:ml-2
          ...
          <motion.div
            ...
            top-[-130px]
            right-[-100px] xl:right-0 lg:right-0
            xl:top-[-30px] lg:top-[-30px]"
            ref={parallaxContainerRef}
            initial={{ y: 0 }}
            style={{ y }}
          >
          ...
          <motion.div
            className="relative z-1 drop-shadow-xl overflow-hidden  mt-[-100px] xl:mt-0 lg:mt-"
            ref={parallaxContainerRef}
            initial={{ y: 0 }}
            style={{ y }}
          >
            <motion.img
              ...
              w-[200px]
              object-cover relative xl:right-5 lg:right-5 
              xl:h-[520px] lg:h-[520px] h-[200px]  "
            />
          </motion.div>
        </div>
      </div>
